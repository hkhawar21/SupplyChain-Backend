...
export namespace Prisma {
  ...
  */
    ...
    > = S extends true
        ...
        ? "include" extends U
            ...
            ? {
                  [P in TrueKeys<
                      S["select"]
                  >]: P extends keyof ProductCountOutputType
    ...
    > = S extends true
        ...
        ? "include" extends U
            ...
            ? {
                  [P in TrueKeys<
                      S["select"]
                  >]: P extends keyof CategoryCountOutputType
    ...
    export type Raw_MaterialCountOutputTypeGetPayload<
        S extends boolean | null | undefined | Raw_MaterialCountOutputTypeArgs,
        U = keyof S,
    > = S extends true
        ? Raw_MaterialCountOutputType
        : S extends undefined
        ? never
        : S extends Raw_MaterialCountOutputTypeArgs
        ? "include" extends U
            ? Raw_MaterialCountOutputType
            : "select" extends U
            ? {
                  [P in TrueKeys<
                      S["select"]
                  >]: P extends keyof Raw_MaterialCountOutputType
                      ? Raw_MaterialCountOutputType[P]
                      : never;
              }
            : Raw_MaterialCountOutputType
        : Raw_MaterialCountOutputType;
    ...
    > = S extends true
        ...
        ? "include" extends U
            ...
            : "select" extends U
            ? {
                  [P in TrueKeys<S["select"]>]: P extends keyof Vendor
                      ? Vendor[P]
                      : never;
              }
            : Vendor
    ...
    export interface VendorDelegate<GlobalRejectSettings> {
         ...
         **/
        findUnique<
            T extends VendorFindUniqueArgs,
            LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound
                ? T["rejectOnNotFound"]
                : undefined,
        >(
        ...
        > extends True
            ? CheckSelect<
                  T,
                  Prisma__VendorClient<Vendor>,
                  Prisma__VendorClient<VendorGetPayload<T>>
              >
            : CheckSelect<
                  T,
                  Prisma__VendorClient<Vendor | null>,
                  Prisma__VendorClient<VendorGetPayload<T> | null>
              >;
        ...
        ): PrismaPromise<GetVendorAggregateType<T>>;
        ...
        >(
            args: SubsetIntersection<T, VendorGroupByArgs, OrderByArg> &
                InputErrors,
        ): {} extends InputErrors
    ...
    export type VendorUpdateManyArgs = {
         ...
         **/
        data: XOR<
            VendorUpdateManyMutationInput,
            VendorUncheckedUpdateManyInput
        >;
        /**
    ...
    > = S extends true
        ...
        ? "include" extends U
            ...
            : "select" extends U
            ? {
                  [P in TrueKeys<S["select"]>]: P extends keyof Order
                      ? Order[P]
                      : never;
              }
            : Order
    ...
    export interface OrderDelegate<GlobalRejectSettings> {
        ...
        > extends True
            ? CheckSelect<
                  T,
                  Prisma__OrderClient<Order>,
                  Prisma__OrderClient<OrderGetPayload<T>>
              >
            : CheckSelect<
                  T,
                  Prisma__OrderClient<Order | null>,
                  Prisma__OrderClient<OrderGetPayload<T> | null>
              >;
        ...
        ): PrismaPromise<GetOrderAggregateType<T>>;
    ...
    export type ProductSelect = {
        ...
        image?: boolean;
        weight?: boolean;
        product_order?: boolean | ProductOrderFindManyArgs;
        inventory?: boolean | InventoryFindManyArgs;
        category?: boolean | CategoryArgs;
        category_name?: boolean;
        category_id?: boolean;
        raw_materials?: boolean | Raw_MaterialFindManyArgs;
    ...
    > = S extends true
        ...
        ? "include" extends U
            ? Product & {
                  [P in TrueKeys<S["include"]>]: P extends "product_order"
                      ? Array<ProductOrderGetPayload<S["include"][P]>>
                      : P extends "inventory"
                      ? Array<InventoryGetPayload<S["include"][P]>>
                      : P extends "category"
                      ? CategoryGetPayload<S["include"][P]>
                      : P extends "raw_materials"
                      ? Array<Raw_MaterialGetPayload<S["include"][P]>>
                      : P extends "_count"
            ...
            : "select" extends U
            ? {
                  [P in TrueKeys<S["select"]>]: P extends "product_order"
                      ? Array<ProductOrderGetPayload<S["select"][P]>>
                      : P extends "inventory"
                      ? Array<InventoryGetPayload<S["select"][P]>>
                      : P extends "category"
                      ? CategoryGetPayload<S["select"][P]>
                      : P extends "raw_materials"
                      ? Array<Raw_MaterialGetPayload<S["select"][P]>>
                      : P extends "_count"
    ...
    export class Prisma__ProductClient<T> implements PrismaPromise<T> {
        ...
        product_order<T extends ProductOrderFindManyArgs = {}>(
            args?: Subset<T, ProductOrderFindManyArgs>,
        ): CheckSelect<
            T,
            PrismaPromise<Array<ProductOrder>>,
            PrismaPromise<Array<ProductOrderGetPayload<T>>>
        >;

        inventory<T extends InventoryFindManyArgs = {}>(
            args?: Subset<T, InventoryFindManyArgs>,
        ): CheckSelect<
            T,
            PrismaPromise<Array<Inventory>>,
        ...
        raw_materials<T extends Raw_MaterialFindManyArgs = {}>(
            args?: Subset<T, Raw_MaterialFindManyArgs>,
        ): CheckSelect<
            T,
            PrismaPromise<Array<Raw_Material>>,
    ...
    > = {
        [P in keyof T & keyof AggregateProductOrder]: P extends
            | "_count"
            | "count"
            ? T[P] extends true
                ? number
        ...
        PrismaPromise<
            Array<
                PickArray<ProductOrderGroupByOutputType, T["by"]> & {
                    [P in keyof T &
                        keyof ProductOrderGroupByOutputType]: P extends "_count"
                        ? T[P] extends boolean
                            ? number
                            : GetScalarType<
                                  T[P],
                                  ProductOrderGroupByOutputType[P]
                              >
    ...
    > = S extends true
        ...
        ? "include" extends U
            ? ProductOrder & {
                  [P in TrueKeys<S["include"]>]: P extends "product"
                      ? ProductGetPayload<S["include"][P]>
                      : never;
              }
            : "select" extends U
            ? {
                  [P in TrueKeys<S["select"]>]: P extends "product"
                      ? ProductGetPayload<S["select"][P]>
                      : P extends keyof ProductOrder
                      ? ProductOrder[P]
                      : never;
              }
            : ProductOrder
    ...
    export interface ProductOrderDelegate<GlobalRejectSettings> {
         ...
         **/
        findUnique<
            T extends ProductOrderFindUniqueArgs,
            LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound
                ? T["rejectOnNotFound"]
                : undefined,
        >(
        ...
        > extends True
            ? CheckSelect<
                  T,
                  Prisma__ProductOrderClient<ProductOrder>,
                  Prisma__ProductOrderClient<ProductOrderGetPayload<T>>
              >
            : CheckSelect<
                  T,
                  Prisma__ProductOrderClient<ProductOrder | null>,
                  Prisma__ProductOrderClient<ProductOrderGetPayload<T> | null>
              >;
         ...
         **/
        findFirst<
            T extends ProductOrderFindFirstArgs,
            LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound
                ? T["rejectOnNotFound"]
                : undefined,
        >(
        ...
        count<T extends ProductOrderCountArgs>(
            ...
            T extends _Record<"select", any>
                ? T["select"] extends true
                    ...
                    : GetScalarType<
                          T["select"],
                          ProductOrderCountAggregateOutputType
                      >
                : number
        >;
        ...
        ): PrismaPromise<GetProductOrderAggregateType<T>>;
    ...
    export class Prisma__CategoryClient<T> implements PrismaPromise<T> {
        ...
        product<T extends ProductFindManyArgs = {}>(
    ...
    export type GetRaw_MaterialAggregateType<
        T extends Raw_MaterialAggregateArgs,
    > = {
        [P in keyof T & keyof AggregateRaw_Material]: P extends
            | "_count"
            | "count"
            ? T[P] extends true
                ? number
    ...
    export type Raw_MaterialGroupByArgs = {
        ...
        by: Array<Raw_MaterialScalarFieldEnum>;
    ...
    type GetRaw_MaterialGroupByPayload<T extends Raw_MaterialGroupByArgs> =
        PrismaPromise<
            Array<
                PickArray<Raw_MaterialGroupByOutputType, T["by"]> & {
                    [P in keyof T &
                        keyof Raw_MaterialGroupByOutputType]: P extends "_count"
                        ? T[P] extends boolean
                            ? number
                            : GetScalarType<
                                  T[P],
                                  Raw_MaterialGroupByOutputType[P]
                              >
    ...
    export type Raw_MaterialGetPayload<
        S extends boolean | null | undefined | Raw_MaterialArgs,
        U = keyof S,
    > = S extends true
        ? Raw_Material
        : S extends undefined
        ? never
        : S extends Raw_MaterialArgs | Raw_MaterialFindManyArgs
        ? "include" extends U
            ? Raw_Material & {
                  [P in TrueKeys<S["include"]>]: P extends "inventory"
                      ? Array<InventoryGetPayload<S["include"][P]>>
                      : P extends "product"
                      ? Array<ProductGetPayload<S["include"][P]>>
                      : P extends "_count"
                      ? Raw_MaterialCountOutputTypeGetPayload<S["include"][P]>
                      : never;
              }
            : "select" extends U
            ? {
                  [P in TrueKeys<S["select"]>]: P extends "inventory"
                      ? Array<InventoryGetPayload<S["select"][P]>>
                      : P extends "product"
                      ? Array<ProductGetPayload<S["select"][P]>>
                      : P extends "_count"
                      ? Raw_MaterialCountOutputTypeGetPayload<S["select"][P]>
                      : P extends keyof Raw_Material
                      ? Raw_Material[P]
                      : never;
              }
            : Raw_Material
    ...
    export interface Raw_MaterialDelegate<GlobalRejectSettings> {
         ...
         **/
        findUnique<
            T extends Raw_MaterialFindUniqueArgs,
            LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound
                ? T["rejectOnNotFound"]
                : undefined,
        >(
        ...
        > extends True
            ? CheckSelect<
                  T,
                  Prisma__Raw_MaterialClient<Raw_Material>,
                  Prisma__Raw_MaterialClient<Raw_MaterialGetPayload<T>>
              >
            : CheckSelect<
                  T,
                  Prisma__Raw_MaterialClient<Raw_Material | null>,
                  Prisma__Raw_MaterialClient<Raw_MaterialGetPayload<T> | null>
              >;
         ...
         **/
        findFirst<
            T extends Raw_MaterialFindFirstArgs,
            LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound
                ? T["rejectOnNotFound"]
                : undefined,
        >(
        ...
        count<T extends Raw_MaterialCountArgs>(
            ...
            T extends _Record<"select", any>
                ? T["select"] extends true
                    ...
                    : GetScalarType<
                          T["select"],
                          Raw_MaterialCountAggregateOutputType
                      >
                : number
        >;
         ...
         * })
         **/
        aggregate<T extends Raw_MaterialAggregateArgs>(
            args: Subset<T, Raw_MaterialAggregateArgs>,
        ): PrismaPromise<GetRaw_MaterialAggregateType<T>>;
        ...
        >(
            args: SubsetIntersection<T, Raw_MaterialGroupByArgs, OrderByArg> &
                InputErrors,
        ): {} extends InputErrors
            ? GetRaw_MaterialGroupByPayload<T>
            : PrismaPromise<InputErrors>;
    }
     ...
     * https://github.com/prisma/prisma-client-js/issues/707
     */
    export class Prisma__Raw_MaterialClient<T> implements PrismaPromise<T> {
        [prisma]: true;
        private readonly _dmmf;
        private readonly _fetcher;
        private readonly _queryType;
     ...
     */
    export type Raw_MaterialFindUniqueArgs = {
        /**
        ...
        /**
         * Throw an Error if a Raw_Material can't be found
         *
         **/
        rejectOnNotFound?: RejectOnNotFound;
        /**
     ...
     */
    export type Raw_MaterialFindFirstArgs = {
        /**
         * Select specific fields to fetch from the Raw_Material
         *
         **/
    ...
    export type Raw_MaterialUpdateManyArgs = {
         ...
         **/
        data: XOR<
            Raw_MaterialUpdateManyMutationInput,
            Raw_MaterialUncheckedUpdateManyInput
        >;
        /**
    ...
    > = S extends true
        ...
        ? "include" extends U
            ...
            : "select" extends U
            ? {
                  [P in TrueKeys<S["select"]>]: P extends keyof Warehouse
                      ? Warehouse[P]
                      : never;
              }
            : Warehouse
    ...
    export interface WarehouseDelegate<GlobalRejectSettings> {
         ...
         **/
        findUnique<
            T extends WarehouseFindUniqueArgs,
            LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound
                ? T["rejectOnNotFound"]
                : undefined,
        >(
        ...
        > extends True
            ? CheckSelect<
                  T,
                  Prisma__WarehouseClient<Warehouse>,
                  Prisma__WarehouseClient<WarehouseGetPayload<T>>
              >
            : CheckSelect<
                  T,
                  Prisma__WarehouseClient<Warehouse | null>,
                  Prisma__WarehouseClient<WarehouseGetPayload<T> | null>
              >;
         ...
         **/
        findFirst<
            T extends WarehouseFindFirstArgs,
            LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound
                ? T["rejectOnNotFound"]
                : undefined,
        >(
        ...
        aggregate<T extends WarehouseAggregateArgs>(
            args: Subset<T, WarehouseAggregateArgs>,
        ): PrismaPromise<GetWarehouseAggregateType<T>>;
        ...
        >(
            args: SubsetIntersection<T, WarehouseGroupByArgs, OrderByArg> &
                InputErrors,
        ): {} extends InputErrors
    ...
    type GetAgentGroupByPayload<T extends AgentGroupByArgs> = PrismaPromise<
        Array<
            PickArray<AgentGroupByOutputType, T["by"]> & {
                [P in keyof T &
                    keyof AgentGroupByOutputType]: P extends "_count"
                    ? T[P] extends boolean
                        ? number
    ...
    > = S extends true
        ...
        : S extends undefined
        ? never
        : S extends AgentArgs | AgentFindManyArgs
        ? "include" extends U
            ? Agent
            : "select" extends U
            ? {
                  [P in TrueKeys<S["select"]>]: P extends keyof Agent
                      ? Agent[P]
                      : never;
              }
            : Agent
    ...
    type AgentCountArgs = Merge<
        Omit<AgentFindManyArgs, "select" | "include"> & {
            select?: AgentCountAggregateInputType | true;
        }
    >;

    export interface AgentDelegate<GlobalRejectSettings> {
        /**
        ...
        > extends True
            ? CheckSelect<
                  T,
                  Prisma__AgentClient<Agent>,
                  Prisma__AgentClient<AgentGetPayload<T>>
              >
            : CheckSelect<
                  T,
                  Prisma__AgentClient<Agent | null>,
                  Prisma__AgentClient<AgentGetPayload<T> | null>
              >;
        ...
        ): PrismaPromise<GetAgentAggregateType<T>>;
        ...
        >(
            args: SubsetIntersection<T, AgentGroupByArgs, OrderByArg> &
                InputErrors,
        ): {} extends InputErrors
     ...
     * https://github.com/prisma/prisma-client-js/issues/707
     */
    export class Prisma__AgentClient<T> implements PrismaPromise<T> {
        [prisma]: true;
        private readonly _dmmf;
        private readonly _fetcher;
        private readonly _queryType;
    ...
    export type AgentFindUniqueArgs = {
        ...
        /**
         * Throw an Error if a Agent can't be found
         *
         **/
        rejectOnNotFound?: RejectOnNotFound;
        /**
    ...
    > = S extends true
        ...
        ? "include" extends U
            ? Inventory & {
                  [P in TrueKeys<S["include"]>]: P extends "raw_materials"
                      ? Raw_MaterialGetPayload<S["include"][P]>
                      : P extends "products"
                      ? ProductGetPayload<S["include"][P]>
                      : never;
              }
            : "select" extends U
            ? {
                  [P in TrueKeys<S["select"]>]: P extends "raw_materials"
                      ? Raw_MaterialGetPayload<S["select"][P]>
                      : P extends "products"
                      ? ProductGetPayload<S["select"][P]>
                      : P extends keyof Inventory
                      ? Inventory[P]
                      : never;
              }
            : Inventory
    ...
    export interface InventoryDelegate<GlobalRejectSettings> {
         ...
         **/
        findUnique<
            T extends InventoryFindUniqueArgs,
            LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound
                ? T["rejectOnNotFound"]
                : undefined,
        >(
        ...
        > extends True
            ? CheckSelect<
                  T,
                  Prisma__InventoryClient<Inventory>,
                  Prisma__InventoryClient<InventoryGetPayload<T>>
              >
            : CheckSelect<
                  T,
                  Prisma__InventoryClient<Inventory | null>,
                  Prisma__InventoryClient<InventoryGetPayload<T> | null>
              >;
         ...
         **/
        findFirst<
            T extends InventoryFindFirstArgs,
            LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound
                ? T["rejectOnNotFound"]
                : undefined,
        >(
        ...
        ): PrismaPromise<GetInventoryAggregateType<T>>;
    ...
    export class Prisma__InventoryClient<T> implements PrismaPromise<T> {
        ...
        raw_materials<T extends Raw_MaterialArgs = {}>(
            args?: Subset<T, Raw_MaterialArgs>,
        ): CheckSelect<
            T,
            Prisma__Raw_MaterialClient<Raw_Material | null>,
            Prisma__Raw_MaterialClient<Raw_MaterialGetPayload<T> | null>
        ...
        products<T extends ProductArgs = {}>(
            args?: Subset<T, ProductArgs>,
        ): CheckSelect<
            T,
            Prisma__ProductClient<Product | null>,
    ...
    export type Raw_MaterialScalarFieldEnum =
        (typeof Raw_MaterialScalarFieldEnum)[keyof typeof Raw_MaterialScalarFieldEnum];
    ...
    export type ProductOrderOrderByRelevanceFieldEnum =
        (typeof ProductOrderOrderByRelevanceFieldEnum)[keyof typeof ProductOrderOrderByRelevanceFieldEnum];
    ...
    export type Raw_MaterialOrderByRelevanceFieldEnum =
        (typeof Raw_MaterialOrderByRelevanceFieldEnum)[keyof typeof Raw_MaterialOrderByRelevanceFieldEnum];
    ...
    export type WarehouseOrderByRelevanceFieldEnum =
        (typeof WarehouseOrderByRelevanceFieldEnum)[keyof typeof WarehouseOrderByRelevanceFieldEnum];
    ...
    export type AgentOrderByRelevanceFieldEnum =
        (typeof AgentOrderByRelevanceFieldEnum)[keyof typeof AgentOrderByRelevanceFieldEnum];
    ...
    export type CategoryWhereUniqueInput = {
        id?: number;
        name_id?: CategoryNameIdCompoundUniqueInput;
    };
    ...
    export type ProductUpdateInput = {
        ...
        product_order?: ProductOrderUpdateManyWithoutProductInput;
        inventory?: InventoryUpdateManyWithoutProductsInput;
        category?: CategoryUpdateOneRequiredWithoutProductInput;
        raw_materials?: Raw_MaterialUpdateManyWithoutProductInput;
    };
    ...
    export type ProductUncheckedUpdateInput = {
        ...
        image?: NullableStringFieldUpdateOperationsInput | string | null;
        weight?: FloatFieldUpdateOperationsInput | number;
        product_order?: ProductOrderUncheckedUpdateManyWithoutProductInput;
        inventory?: InventoryUncheckedUpdateManyWithoutProductsInput;
        category_name?: StringFieldUpdateOperationsInput | string;
        category_id?: IntFieldUpdateOperationsInput | number;
        raw_materials?: Raw_MaterialUncheckedUpdateManyWithoutProductInput;
    };
    ...
    export type ProductOrderUpdateInput = {
        ...
        product?: ProductUpdateOneRequiredWithoutProduct_orderInput;
    };
    ...
    export type Raw_MaterialUpdateInput = {
        name?: StringFieldUpdateOperationsInput | string;
        quantity?: IntFieldUpdateOperationsInput | number;
        inventory?: InventoryUpdateManyWithoutRaw_materialsInput;
        product?: ProductUpdateManyWithoutRaw_materialsInput;
    };
    ...
    export type Raw_MaterialUncheckedUpdateInput = {
        ...
        name?: StringFieldUpdateOperationsInput | string;
        quantity?: IntFieldUpdateOperationsInput | number;
        inventory?: InventoryUncheckedUpdateManyWithoutRaw_materialsInput;
        product?: ProductUncheckedUpdateManyWithoutRaw_materialsInput;
    };
    ...
    export type InventoryUpdateInput = {
        raw_materials?: Raw_MaterialUpdateOneRequiredWithoutInventoryInput;
        products?: ProductUpdateOneRequiredWithoutInventoryInput;
    };
    ...
    export type Raw_MaterialListRelationFilter = {
    ...
    export type Raw_MaterialOrderByRelationAggregateInput = {
        _count?: SortOrder;
    };
    ...
    export type CategoryNameIdCompoundUniqueInput = {
        name: string;
        id: number;
    };
    ...
    export type ProductOrderCreateNestedManyWithoutProductInput = {
        create?: XOR<
            Enumerable<ProductOrderCreateWithoutProductInput>,
            Enumerable<ProductOrderUncheckedCreateWithoutProductInput>
        >;
    ...
    export type InventoryCreateNestedManyWithoutProductsInput = {
        create?: XOR<
            Enumerable<InventoryCreateWithoutProductsInput>,
            Enumerable<InventoryUncheckedCreateWithoutProductsInput>
        >;
    ...
    export type Raw_MaterialCreateNestedManyWithoutProductInput = {
        create?: XOR<
            Enumerable<Raw_MaterialCreateWithoutProductInput>,
            Enumerable<Raw_MaterialUncheckedCreateWithoutProductInput>
        >;
    ...
    export type ProductOrderUpdateManyWithoutProductInput = {
        create?: XOR<
            Enumerable<ProductOrderCreateWithoutProductInput>,
            Enumerable<ProductOrderUncheckedCreateWithoutProductInput>
        >;
    ...
    export type InventoryUpdateManyWithoutProductsInput = {
        create?: XOR<
            Enumerable<InventoryCreateWithoutProductsInput>,
            Enumerable<InventoryUncheckedCreateWithoutProductsInput>
        >;
    ...
    export type Raw_MaterialUpdateManyWithoutProductInput = {
        create?: XOR<
            Enumerable<Raw_MaterialCreateWithoutProductInput>,
            Enumerable<Raw_MaterialUncheckedCreateWithoutProductInput>
        >;
    ...
    export type Raw_MaterialUncheckedUpdateManyWithoutProductInput = {
        create?: XOR<
            Enumerable<Raw_MaterialCreateWithoutProductInput>,
            Enumerable<Raw_MaterialUncheckedCreateWithoutProductInput>
        >;
    ...
    export type ProductCreateNestedOneWithoutProduct_orderInput = {
        create?: XOR<
            ProductCreateWithoutProduct_orderInput,
            ProductUncheckedCreateWithoutProduct_orderInput
        >;
        connectOrCreate?: ProductCreateOrConnectWithoutProduct_orderInput;
        connect?: ProductWhereUniqueInput;
    };

    export type ProductUpdateOneRequiredWithoutProduct_orderInput = {
        create?: XOR<
            ProductCreateWithoutProduct_orderInput,
            ProductUncheckedCreateWithoutProduct_orderInput
        >;
        ...
        connect?: ProductWhereUniqueInput;
        update?: XOR<
            ProductUpdateWithoutProduct_orderInput,
            ProductUncheckedUpdateWithoutProduct_orderInput
        >;
    };
    ...
    export type InventoryCreateNestedManyWithoutRaw_materialsInput = {
        create?: XOR<
            Enumerable<InventoryCreateWithoutRaw_materialsInput>,
            Enumerable<InventoryUncheckedCreateWithoutRaw_materialsInput>
        >;
    ...
    export type ProductCreateNestedManyWithoutRaw_materialsInput = {
        create?: XOR<
            Enumerable<ProductCreateWithoutRaw_materialsInput>,
            Enumerable<ProductUncheckedCreateWithoutRaw_materialsInput>
        >;
        connectOrCreate?: Enumerable<ProductCreateOrConnectWithoutRaw_materialsInput>;
        connect?: Enumerable<ProductWhereUniqueInput>;
    };
    ...
    export type ProductUncheckedCreateNestedManyWithoutRaw_materialsInput = {
        create?: XOR<
            Enumerable<ProductCreateWithoutRaw_materialsInput>,
            Enumerable<ProductUncheckedCreateWithoutRaw_materialsInput>
        >;
    ...
    export type InventoryUpdateManyWithoutRaw_materialsInput = {
        create?: XOR<
            Enumerable<InventoryCreateWithoutRaw_materialsInput>,
            Enumerable<InventoryUncheckedCreateWithoutRaw_materialsInput>
        >;
    ...
    export type ProductUpdateManyWithoutRaw_materialsInput = {
        create?: XOR<
            Enumerable<ProductCreateWithoutRaw_materialsInput>,
            Enumerable<ProductUncheckedCreateWithoutRaw_materialsInput>
        >;
        connectOrCreate?: Enumerable<ProductCreateOrConnectWithoutRaw_materialsInput>;
        upsert?: Enumerable<ProductUpsertWithWhereUniqueWithoutRaw_materialsInput>;
        set?: Enumerable<ProductWhereUniqueInput>;
        disconnect?: Enumerable<ProductWhereUniqueInput>;
        delete?: Enumerable<ProductWhereUniqueInput>;
        connect?: Enumerable<ProductWhereUniqueInput>;
        update?: Enumerable<ProductUpdateWithWhereUniqueWithoutRaw_materialsInput>;
        updateMany?: Enumerable<ProductUpdateManyWithWhereWithoutRaw_materialsInput>;
        deleteMany?: Enumerable<ProductScalarWhereInput>;
    };

    export type InventoryUncheckedUpdateManyWithoutRaw_materialsInput = {
        create?: XOR<
            Enumerable<InventoryCreateWithoutRaw_materialsInput>,
            Enumerable<InventoryUncheckedCreateWithoutRaw_materialsInput>
        >;
    ...
    export type ProductUncheckedUpdateManyWithoutRaw_materialsInput = {
        create?: XOR<
            Enumerable<ProductCreateWithoutRaw_materialsInput>,
            Enumerable<ProductUncheckedCreateWithoutRaw_materialsInput>
        >;
    ...
    export type Raw_MaterialCreateNestedOneWithoutInventoryInput = {
        create?: XOR<
            Raw_MaterialCreateWithoutInventoryInput,
            Raw_MaterialUncheckedCreateWithoutInventoryInput
        >;
    ...
    export type Raw_MaterialUpdateOneRequiredWithoutInventoryInput = {
        create?: XOR<
            Raw_MaterialCreateWithoutInventoryInput,
            Raw_MaterialUncheckedCreateWithoutInventoryInput
        >;
        ...
        connect?: Raw_MaterialWhereUniqueInput;
        update?: XOR<
            Raw_MaterialUpdateWithoutInventoryInput,
            Raw_MaterialUncheckedUpdateWithoutInventoryInput
        >;
    };
    ...
    export type ProductOrderCreateOrConnectWithoutProductInput = {
        ...
        create: XOR<
            ...
            ProductOrderUncheckedCreateWithoutProductInput
        >;
    };
    ...
    export type Raw_MaterialCreateOrConnectWithoutProductInput = {
        where: Raw_MaterialWhereUniqueInput;
        create: XOR<
            Raw_MaterialCreateWithoutProductInput,
            Raw_MaterialUncheckedCreateWithoutProductInput
        >;
    };
    ...
    export type ProductOrderUpsertWithWhereUniqueWithoutProductInput = {
        where: ProductOrderWhereUniqueInput;
        update: XOR<
            ProductOrderUpdateWithoutProductInput,
            ProductOrderUncheckedUpdateWithoutProductInput
        >;
        create: XOR<
            ProductOrderCreateWithoutProductInput,
            ProductOrderUncheckedCreateWithoutProductInput
    ...
    export type ProductOrderUpdateManyWithWhereWithoutProductInput = {
        ...
        data: XOR<
            ProductOrderUpdateManyMutationInput,
            ProductOrderUncheckedUpdateManyWithoutProduct_orderInput
        >;
    };
    ...
    export type InventoryUpsertWithWhereUniqueWithoutProductsInput = {
        ...
        update: XOR<
            ...
            InventoryUncheckedUpdateWithoutProductsInput
        >;
        create: XOR<
            InventoryCreateWithoutProductsInput,
            InventoryUncheckedCreateWithoutProductsInput
    ...
    export type InventoryUpdateManyWithWhereWithoutProductsInput = {
        ...
        data: XOR<
            InventoryUpdateManyMutationInput,
            InventoryUncheckedUpdateManyWithoutInventoryInput
        >;
    };
    ...
    export type Raw_MaterialUpsertWithWhereUniqueWithoutProductInput = {
        where: Raw_MaterialWhereUniqueInput;
        update: XOR<
            Raw_MaterialUpdateWithoutProductInput,
            Raw_MaterialUncheckedUpdateWithoutProductInput
        >;
        create: XOR<
            Raw_MaterialCreateWithoutProductInput,
            Raw_MaterialUncheckedCreateWithoutProductInput
    ...
    export type Raw_MaterialUpdateManyWithWhereWithoutProductInput = {
        ...
        data: XOR<
            Raw_MaterialUpdateManyMutationInput,
            Raw_MaterialUncheckedUpdateManyWithoutRaw_materialsInput
        >;
    };

    export type Raw_MaterialScalarWhereInput = {
        AND?: Enumerable<Raw_MaterialScalarWhereInput>;
        OR?: Enumerable<Raw_MaterialScalarWhereInput>;
        NOT?: Enumerable<Raw_MaterialScalarWhereInput>;
        id?: IntFilter | number;
        name?: StringFilter | string;
        quantity?: IntFilter | number;
    };
    ...
    export type InventoryCreateOrConnectWithoutRaw_materialsInput = {
        where: InventoryWhereUniqueInput;
        create: XOR<
            InventoryCreateWithoutRaw_materialsInput,
            InventoryUncheckedCreateWithoutRaw_materialsInput
        >;
    };
    ...
    export type ProductCreateWithoutRaw_materialsInput = {
        name: string;
        price_per_unit: number;
        status: boolean;
        image?: string | null;
    ...
    export type ProductCreateOrConnectWithoutRaw_materialsInput = {
        where: ProductWhereUniqueInput;
        create: XOR<
            ProductCreateWithoutRaw_materialsInput,
            ProductUncheckedCreateWithoutRaw_materialsInput
        >;
    };
    ...
    export type InventoryUpsertWithWhereUniqueWithoutRaw_materialsInput = {
        where: InventoryWhereUniqueInput;
        update: XOR<
            InventoryUpdateWithoutRaw_materialsInput,
            InventoryUncheckedUpdateWithoutRaw_materialsInput
        >;
        create: XOR<
            InventoryCreateWithoutRaw_materialsInput,
            InventoryUncheckedCreateWithoutRaw_materialsInput
    ...
    export type ProductUpsertWithWhereUniqueWithoutRaw_materialsInput = {
        where: ProductWhereUniqueInput;
        update: XOR<
            ProductUpdateWithoutRaw_materialsInput,
            ProductUncheckedUpdateWithoutRaw_materialsInput
        >;
        create: XOR<
            ProductCreateWithoutRaw_materialsInput,
            ProductUncheckedCreateWithoutRaw_materialsInput
    ...
    export type ProductUpdateWithWhereUniqueWithoutRaw_materialsInput = {
        where: ProductWhereUniqueInput;
        data: XOR<
            ProductUpdateWithoutRaw_materialsInput,
            ProductUncheckedUpdateWithoutRaw_materialsInput
    ...
    export type Raw_MaterialUncheckedUpdateManyWithoutRaw_materialsInput = {
        id?: IntFieldUpdateOperationsInput | number;
        name?: StringFieldUpdateOperationsInput | string;
        quantity?: IntFieldUpdateOperationsInput | number;
    };
    ...
    export type ProductUpdateWithoutRaw_materialsInput = {
        name?: StringFieldUpdateOperationsInput | string;
        price_per_unit?: FloatFieldUpdateOperationsInput | number;
        status?: BoolFieldUpdateOperationsInput | boolean;
        image?: NullableStringFieldUpdateOperationsInput | string | null;
