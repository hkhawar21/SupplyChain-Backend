...
const seedDatabase = async () => {
    ...
    const rawMaterials = [
        {
            ...
            requestedStatus: type_graphql_1.RawMaterialStatus.PENDING,
        },
        {
            name: "Coal",
            price: 8.99,
    ...
    const createdProductRawMaterials = await prisma.productRawMaterials.createMany({
    ...
    const orders = [
        {
            quantity: 5,
            status: type_graphql_1.OrderStatus.PENDING,
            amount: 54.95,
        ...
        {
            quantity: 4,
            status: type_graphql_1.OrderStatus.PROCESSING,
            amount: 79.96,
        ...
        {
            quantity: 5,
            status: type_graphql_1.OrderStatus.DELIVERED,
            amount: 74.95,
